...
import { Star, X, Clock, BookOpen, Award, MessageCircle, Calendar, MapPin, GraduationCap, CheckCircle } from "lucide-react";
...
export default function TutorDetailSidebar({ tutor, isOpen, onClose, onStartChat }: TutorDetailSidebarProps) {
  ...
  const handleChat = () => {
    ...
    // Call parent function to handle chat and close sidebar
    if (tutor.name) {
